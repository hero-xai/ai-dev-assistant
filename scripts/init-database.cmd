...
set DB_NAME=ai_dev_assistant
set SCHEMA_FILE=%~dp0..\src\main\resources\db\schema.sql
...
call "%~dp0start-mysql.cmd"

"%MYSQL_BIN%" --user=%MYSQL_USERNAME% --password=%MYSQL_PASSWORD% --protocol=tcp --host=127.0.0.1 --port=3306 --default-character-set=utf8mb4 %DB_NAME% < "%SCHEMA_FILE%"
